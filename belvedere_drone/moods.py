...
class Mood:
    def __init__(self, name, notes_per_breath, step_leap_ratio, ornament_rate,
                 ...
                 breath_mean_s, trill_rate, call_response, phrase_shape):
        self.name = name
